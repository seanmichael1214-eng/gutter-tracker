...
## Multi-Agent Project Setup & Collaboration Guide

This template helps you set up consistent documentation across all your projects for seamless collaboration with multiple AI CLI agents (Claude, Gemini, Cursor, Copilot, etc.).

---

## 📋 Quick Setup Checklist

When starting ANY new project, create these files immediately:

- [ ] `AGENTS.md` - Main development guide
- [ ] `CLAUDE.md` - Claude-specific context
- [ ] `GEMINI.md` - Gemini-specific context
- [ ] `CURSOR.md` - Cursor IDE context (optional)
- [ ] `TROUBLESHOOTING.md` - Common issues & solutions
- [ ] `CLEANUP.md` - Disk space & maintenance
- [ ] `.clinerules` - Project-specific AI rules (optional)

---

## 🚀 One-Command Project Initialization

Save this script as `init-ai-docs.sh` in your project root:
...
chmod +x init-ai-docs.sh

echo "✅ AI agent workflow template created successfully!"
